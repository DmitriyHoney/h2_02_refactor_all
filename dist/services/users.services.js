...
let UsersService = class UsersService {
    ...
    createConfirmedUser(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersCommandRepo.create(body);
        });
    }
    createNotConfirmedUser(body, code) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersCommandRepo.create(Object.assign(Object.assign({}, body), { confirmedInfo: {
    ...
    update(userId, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersCommandRepo.update(userId, body);
        });
    }
    deleteOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersCommandRepo.deleteOne(id);
        });
    }
    deleteAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersCommandRepo.deleteAll();
        });
    }
};
